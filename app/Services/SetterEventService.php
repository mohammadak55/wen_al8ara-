...
class SetterEventService
{
    public function createEvent($request)
    {
        ...
        $messages = [
            ...
            "اغتيال" => "نفذت القوات الإسرائيلية محاولة إغتيال جبانة في منطقة $check->regions",
            "قصف مدفعي" => "تعرضت منطقة $check->regions لقصف مدفعي من قبل القوات الإسرائيلية",
            "غارة من مسيرة" => "نفذت طائرة مسيرة إسرائيلية غارة على   $check->regions",
            "تحليق مسيرة" => "رصدت مسيرات إسرائيلية تحلق فوق اجواء $check->regions . ",
            "تحليق طيران حربي" => " الطيران الحربي الإسرائيلي يخرق الأجواء اللبنانية",
            "جدار صوت" => "خرق الطيران الحربي الإسرائيلي جدار صوتي فوق سماء الجنوب اللبناني",
    ...
    public function updateEventDetail($request, $id)
    {
        ...
        $messages = [
            ...
            "جدار صوت" => "خرق الطيران الحربي الإسرائيلي جدار صوتي فوق سماء الجنوب اللبناني",
            "غارة من حربي" => "قام العدو الإسرائيلي بالإغارة على منطقة $check->regions",
            "نفي الحدث" => "إقتضى التوضيح : لا يوجد حدث في منطقة $check->regions ."
        ];
